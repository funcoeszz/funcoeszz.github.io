...
local URL='http://www.portoeditora.pt/dol/default.asp'
local INI='^Procure livro' FIM='^termos e condi'
$ZZWWWDUMP "$URL?param=08010100&operacao=def&palavra=$1" |
sed -n "s/^ *//;/$INI/,/$FIM/{/$INI\|$FIM/d;p;}"
}
