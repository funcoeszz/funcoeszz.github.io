...
local URL limite n=5 s='byotcipn'; limite="sed ${n}q"; [ "$1" ] && s="$1"
...
URL='http://www.slackware.com/security/list.php?l=slackware-security&y=2004'
...
$ZZWWWDUMP "$URL"| sed -n 's/^ *\([Ff]edora: \)/\1/p' | $limite ; }
...
# Tradução de palavras em inglês para vários idiomas
